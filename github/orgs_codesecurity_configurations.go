...
// GetOrganizationCodeSecurityConfigurations gets code security configurations for an organization.
//
...
func (s *OrganizationsService) GetOrganizationCodeSecurityConfigurations(ctx context.Context, org string) ([]*CodeSecurityConfiguration, *Response, error) {
...
// GetOrganizationDefaultCodeSecurityConfigurations gets default code security configurations for an organization.
//
// GitHub API docs: https://docs.github.com/en/rest/code-security/configurations#get-default-code-security-configurations
//
//meta:operation GET /orgs/{org}/code-security/configurations/default
func (s *OrganizationsService) GetOrganizationDefaultCodeSecurityConfigurations(ctx context.Context, org string) ([]*CodeSecurityConfiguration, *Response, error) {
	u := fmt.Sprintf("orgs/%v/code-security/configurations/default", org)
...
// GetOrganizationCodeSecurityConfiguration gets a code security configuration available in an organization.
//
...
func (s *OrganizationsService) GetOrganizationCodeSecurityConfiguration(ctx context.Context, org string, id int64) (*CodeSecurityConfiguration, *Response, error) {
...
//
//meta:operation POST /orgs/{org}/code-security/configurations/attach
func (s *OrganizationsService) AttachCodeSecurityConfigurationsToRepositories(ctx context.Context, org string, repoIDs []int64) (*Response, error) {
	u := fmt.Sprintf("orgs/%v/code-security/configurations/attach", org)
	type selectedRepoIDs struct {
		Scope       string  `json:"scope"`
		SelectedIDs []int64 `json:"selected_repository_ids"`
	}
	req, err := s.client.NewRequest("POST", u, selectedRepoIDs{Scope: "selected", SelectedIDs: repoIDs})
	if err != nil {
		return nil, err
	}
	resp, err := s.client.Do(ctx, req, nil)
...
//
//meta:operation POST /orgs/{org}/code-security/configurations/{configuration_id}/defaults
func (s *OrganizationsService) SetDefaultCodeSecurityConfiguration(ctx context.Context, org string, id int64, newReposParam string) ([]*CodeSecurityConfiguration, *Response, error) {
	...
	req, err := s.client.NewRequest("POST", u, configParam{defaultForNewRepos: newReposParam})
	if err != nil {
		return nil, nil, err
	}
	var configurations []*CodeSecurityConfiguration
